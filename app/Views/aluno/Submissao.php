...
<body>
    ...
    <div class="container">
        ...
        <form method="post">
            ...
            <tr>
                <td>Titulo trabalho: </td>
                <td><input class="form-control" type="text" name='titulotrabalho'></td><br><br>
            </tr>
            <tr>
                <td>Curso</td>
            ...
            <tr>
                <td>Autor</td>
                <td><input class="form-control" type="text" name='autor'></td><br><br>
            </tr>

            <tr>
                <td><input class="btn btn-primary" type="submit" value="enviar"></td><br><br>
            </tr>
