...
<head>
    <meta charset="UTF-8">
    <title>Welcome to my Sistem Simpac</title>
...
<body>
    ...
    <header>
        ...
        <div class="heroe">
            ...
            <h1>Welcome to my Sistem Simpac</h1>

            <h2>Desenvolvido por Robson </h2>
    ...
    <footer>
        ...
        <div class="copyrights">
            ...
            <p>&copy; <?= date('Y') ?> Robinho Foundation. open source project released under the MIT
